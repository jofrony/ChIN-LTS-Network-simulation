...
with open("config-Figure7-Simulate-Network-cortical-increase.json",'r') as parameter_file:
...
#Crtx_Stim = elephant.spike_train_generation.homogeneous_poisson_process(100* pq.Hz,t_stop = 13150 * pq.ms, t_start=13000 * pq.ms)
